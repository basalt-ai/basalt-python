...
class Trace:
    ...
    def append(self, generation: "Generation") -> "Trace":
        ...
        if generation.trace:
            generation.trace.logs = [
                log for log in generation.trace.logs if log.id != generation.id
            ]
    ...
    def create_generation(self, params: Dict[str, Any]) -> "Generation":
        ...
        generation = Generation({**params, "name": name, "trace": self})
