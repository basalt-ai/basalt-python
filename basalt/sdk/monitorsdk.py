...
class MonitorSDK:
    ...
    def create_trace(self, slug: str, params: Optional[Dict[str, Any]] = None) -> Trace:
        """
    ...
    def _create_trace(self, slug: str, params: TraceParams) -> Trace:
        """
    ...
    def _create_log(self, params: LogParams) -> Log:
        """
