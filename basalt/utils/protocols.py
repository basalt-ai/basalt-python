...
class IPromptSDK(Protocol):
    async def get(self, slug: str, tag: Optional[str] = None, version: Optional[str] = None, variables: Dict[str, str] = {}, cache_enabled: bool = True) -> GetResult: ...
    def get_sync(self, slug: str, tag: Optional[str] = None, version: Optional[str] = None, variables: Dict[str, str] = {}, cache_enabled: bool = True) -> GetResult: ...
...
class IDatasetSDK(Protocol):
    ...
    async def addRow(self, slug: str, values: Dict[str, str], name: Optional[str] = None,
                  ideal_output: Optional[str] = None, metadata: Optional[Dict[str, Any]] = None) -> CreateDatasetItemResult: ...
    def addRow_sync(self, slug: str, values: Dict[str, str], name: Optional[str] = None,
                  ideal_output: Optional[str] = None, metadata: Optional[Dict[str, Any]] = None) -> CreateDatasetItemResult: ...
