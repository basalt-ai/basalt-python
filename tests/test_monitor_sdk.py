...
from basalt.utils.dtos import PromptModel, PromptResponse
...
class TestMonitorSDKIntegration(unittest.TestCase):
    ...
    def test_prompt_generation_integration(self):
        ...
        self.assertEqual(generation.input,
                         "Answer the following question about machine learning: What are the best practices for machine learning model deployment?")
